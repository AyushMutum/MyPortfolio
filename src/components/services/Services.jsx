        ...
        <article className="service">
          ...
          <ul className='service__list'>
            <li>
             ...
             <p>Front-end Development: Building responsive and interactive user interfaces using HTML, CSS, Bootstrap and JavaScript to create engaging web experiences.
</p>
            </li>
            <li>
              <BiCheck className='service'/>
